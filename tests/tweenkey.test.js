...
// describe('Tweenkey Global Object', function () {
//     var accessors = [
//         'set',
//         'tween',
//         'from',
...
//         'autoUpdate'
//     ];
//     it('should respond to all accessors', function () {
//         accessors.forEach(function (v) {
//             expect(Tweenkey).to.respondTo(v);
//         });
//     });
// });

// describe('Global actions on tweens', function () {
...
//             tweens.push(Tweenkey.tween({ x: 0 }, 1, {
//                 from: { x: 0 }, to: { x: 1 }
//             }));
...
//             expect(tweens[i]).to.have.property('_queued').and.equal(false);
//         }
//     });

//     it('pauseAll: should halt all tweens', function () {
//         var tweens = [];
//         for (var i = 10; i--;) {
...
//         Tweenkey.update(1);
//         for (var i = tweens.length; i--;) {
//             expect(tweens[i]._running).to.equal(false);
...
// describe('[tween, from, to] common features', function () {
//     var accessors = ['tween', 'from', 'to'];
//     var tweenMethods = [
//         'delay', 'progress', 'time', 'render', 'restart',
//         'reverse', 'timeScale', 'kill', 'pause', 'resume'
//     ];

//     it('should return an instance', function () {
//         accessors.forEach(function (v) {
//             var t = Tweenkey[v]({ x: 0 }, 0.1, { x: 1 });
//             expect(t).to.be.a.function;
//             Tweenkey.killAll();
//         });
//     });

//     it('should respond to all tween accessors', function () {
//         accessors.forEach(function (v) {
//             var t = Tweenkey[v]({ x: 0 }, 0.1, { x: 1 });
//             tweenMethods.forEach(function (m) {
//                 expect(t).to.respondTo(m);
//             });
//             Tweenkey.killAll();
//         });
//     });
